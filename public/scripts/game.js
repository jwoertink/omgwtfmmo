...
Game.start = function(mapData, x, y) {
  ...
  Game.viewport.x = x;
  Game.viewport.y = y;
  Game.tile.store(0, 'public/images/tile_black.png');
  Game.tile.store(1, 'public/images/tile_grass.png');
  Game.tile.store(2, 'public/images/tile_rock.png');
	Game.tile.store(3, 'public/images/ladderdown.png');
	Game.tile.store(4, 'public/images/ladderup.png');
	Game.tile.store(5, 'public/images/cave.png');
	Game.tile.store(6, 'public/images/sign.png');
	Game.setMap(mapData);
	
	Game.player.store(0, 'public/images/scientist_n0.png');
	Game.player.store(1, 'public/images/scientist_n1.png');
	Game.player.store(2, 'public/images/scientist_n2.png');
	Game.player.store(3, 'public/images/scientist_e0.png');
	Game.player.store(4, 'public/images/scientist_e1.png');
	Game.player.store(5, 'public/images/scientist_e2.png');
	Game.player.store(6, 'public/images/scientist_s0.png');
	Game.player.store(7, 'public/images/scientist_s1.png');
	Game.player.store(8, 'public/images/scientist_s2.png');
	Game.player.store(9,  'public/images/scientist_w0.png');
	Game.player.store(10, 'public/images/scientist_w1.png');
	Game.player.store(11, 'public/images/scientist_w2.png');
